...
function PopularDestinations(props) {
  ...
  return (
    <div className="w-full min-h-screen flex justify-center items-center my-8">
     {
    isLoading ?
   <Spinner/> :
   <>
{
 ...
 : 
    ...
    <div className="w-11/12 flex flex-col ">
        ...
        <img src={destinationData.image_url} alt={country} 
    ...
    <div className='w-full flex flex-col my-9 overflow-x-hidden'>
        <h1  data-aos="fade-left" className="font-bold capitalize text-3xl md:text-6xl text-center my-8    background-image: url(/image/lake-como-italian-alke.jpg);  md:my-14 ">{country} Top Destinations</h1>
